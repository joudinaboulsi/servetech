                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="col-md-12">
                            ...
                            <form method="POST" action="{{ route('storeSectionTwo') }}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="mb-3 mt-4">
                                    ...
                                    <input type="text" name="main_title" class="form-control"
                                        id="defaultFormControlInput" placeholder="Main Title"
                                ...
                                <div class="mb-3 mt-4">
                                        ...
                                        <textarea class="form-control" name="content" aria-label="With textarea" placeholder="Content"></textarea>
